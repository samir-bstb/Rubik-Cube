...
class Cube:
    def __init__(self): #First we inicialize the cube the the inicial state
        self.front_mtx = [
            [0, 0, 0],  # white
            [0, 0, 0],
            [0, 0, 0]
    ...
    #All 12 moves are defined on the following functions
    def move_F(self):
    ...
    #changes the syte of the cube depending on the moves sent by the user
    ...
    #changes the syte of the cube randomly
    ...
    def encode(self):
        cubo = [self.up_mtx, self.front_mtx, self.low_mtx, self.left_mtx, self.right_mtx, self.back_mtx]
        int_arr = []
        cont = 0 
        x = np.int64(0)
